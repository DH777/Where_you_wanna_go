...
// Attach a listener to read the data at our posts reference
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                attemptLogin();
                try {
                    snap.child("users").child(username).toString();
                    snap.child("users").child(username).child("password").toString();
                    snap.child("users").child(username).child("password").getValue().toString();
                ...
                if (check) {
                    Intent myIntent = new Intent(LoginActivity.this, UserInformationActivity.class);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            mEmailView.setError(getString(R.string.error_login_incorrect));
            focusView = mEmailView;
            cancel = true;
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            if (reg) {
                ...
                l.add(new Location("A", "desc", -5, 10, false));

                r.child("locations").setValue(l);
